							...
							<div class="card-body">	
									<form action="index.php?page=list" id="filter" method="POST">
			        					<div class="row">
			        						...
			        						<div class="col-md-3">
			        							<br>
                                              <button class="btn-btn-block btn-outline-primary mt-3" type="submit" onclick="log()">Check Availability</button>
			        						</div>
							...
							<div class="card-body">
								...
								<div class="col-md-5" height="100%">
									...
									<div class="align-self-end mt-5">
										<button class="btn btn-primary  float-right book_now" type="button" data-id="<?php echo $row['category_id'] ?>" id="book_now" onclick="log()">Book now</button>
									</div>
								</div>
							</div>

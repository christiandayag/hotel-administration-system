...
<nav id="sidebar" class='mx-lt-5' >
		...
		<div class="sidebar-list">
            <a href="index.php?page=home" class="nav-item nav-check_in"><span class='icon-field'><i class="fa fa-bars"></i></span> Dashboard</a>
            <a href="index.php?page=reservation" class="nav-item nav-check_in"><span class='icon-field'><i class="fa fa-book-open"></i></span> Reservation</a>
                <a href="index.php?page=check_in" class="nav-item nav-check_in"><span class='icon-field'><i class="fa-solid fa-check-to-slot"></i></span> Walk In</a>
				<a href="index.php?page=booked" class="nav-item nav-booked"><span class='icon-field'><i class="fa fa-book"></i></span> Booked </a>
				<a href="index.php?page=check_out" class="nav-item nav-check_out"><span class='icon-field'><i class="fa fa-sign-out-alt"></i></span> Check Out </a>
				<a href="index.php?page=categories" class="nav-item nav-categories"><span class='icon-field'><i class="fa fa-bed"></i></span> Room Category</a>
				...
				<a href="index.php?page=sales" class="nav-item nav-sales"><span class='icon-field'><i class="fa-solid fa-file"></i></span> Sales</a>
				...
				<!-- <li>
				 <a href="#"><i class="fa fa-file" style="color :green font-size:24px"></i>Reports<span class="fa arrow"></span></a>

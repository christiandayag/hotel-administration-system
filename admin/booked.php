                        ...
                        <table class="table table-bordered table-striped">
                            ...
                            while($row=$checked->fetch_assoc()):
                                ...
                                <tr>
                                    ...
                                    <?php if($row['status'] == 1): ?>
                                        <td class="text-center"><span class="btn btn-sm btn-outline-primary">Checked-IN</span></td>
                                    <?php endif; ?>
                                    <td class="text-center">
                                        <button class="btn btn-sm btn-outline-primary check_out" type="button" data-id="<?php echo $row['id'] ?>">View</button>
                                       <!-- <a href="booked_cancel.php?checked_id=<?php echo $row['id'] ?>&room_id=<?php echo $row['room_id']?>" class="btn btn-sm btn-danger check_out">Cancel</a> !-->
                                    </td>
                                </tr>
                            <?php endwhile; ?>
                            </tbody>

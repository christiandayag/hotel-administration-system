...
<!--</style>-->
<!---->
<!--<main role="main" class="container m-3 p-4">-->
<!--    <div class="card">-->
<!--        <div class="card-body">-->
...
<!--                    </div>-->
<!--                    <div class="col-md-4 mb-4 ">-->
<!--                        <div class="card card-dark-blue bg-primary">-->
<!--                            <div class="card-body text-white ">-->
<!--                                --><?php
...
<!--            </div>-->
<!--        <div class="container">-->
<!--            <h3 class="card-header">Weekly Report</h3>-->
<!--            --><?php
//            $sql=mysqli_query($conn,"SELECT * FROM checked");
//            if (mysqli_num_rows($sql)>0){
//                $da=array();
//                while ($row=mysqli_fetch_assoc($sql)){
//                    $da[]=date("Y-m-d",strtotime($row["date_out"]));
//                   $total=$row['status'];
//                }
//            }
...
//                $to=$_POST['to'];
//
//                $sql1=mysqli_query($conn,"SELECT * FROM checked WHERE `date_out` >= '$from' AND `date_out` <= '$to'");
...
<!--                <input type="submit" class="btn-primary btn btn-sm" name="interval" value="Submit">-->
<!--            </form>-->
...
<!---->
<!--<script>-->
<!--    const da = --><?php //echo json_encode($da)?>//;

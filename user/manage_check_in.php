...
<div class="container-fluid">
    ...
    <form action="" id="manage-check">
        ...
        <?php endif;
        $sel = mysqli_query($conn, "SELECT users.name,users.password,users.username,account.id,account.name,account.contact,account.email FROM users inner JOIN account ON users.name=account.name where account.name='" . $_SESSION['login_name'] . "'");
        ...
        <div class="form-group">
            ...
            <input type="text" name="name" id="name" class="form-control" value="<?php echo $_SESSION['login_name'] ?>" required>
        </div>
        <div class="form-group">

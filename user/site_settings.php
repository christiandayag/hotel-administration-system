		...
		<div class="card-body">
			<form action="" id="manage-settings">
				<div class="form-group">
					...
					<input type="text" class="form-control" id="name" name="name" value="<?php echo isset($meta['hotel_name']) ? $meta['hotel_name'] : '' ?>" >
				</div>
				<div class="form-group">
				...
				<center>
					<button class="btn btn-info btn-outline-primary btn-block col-md-2">Save</button>
				</center>
			</form>
		</div>
	</div>

					...
					<div class="card-body">
						<table class="table table-bordered table-striped">
							...
							<tbody>
								<?php 
								$i = 1;
								$checked = $conn->query("SELECT * FROM checked where status = 2 order by status desc, id asc ");
								...
								<tr>
									...
									<td class="text-center">
											...
											<a href="invoice.php?id=<?php echo $row['id'] ?>&ref=<?php echo $row['ref_no']?>" class="btn btn-sm btn-outline-danger" type="button">Invoice</a>
									</td>
								</tr>
							<?php endwhile; ?>
							</tbody>

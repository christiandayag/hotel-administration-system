...
<!--                                    <td class="">--><?php //echo $row['room'] ?><!--</td>-->
                                    ...
                                    <td class="text-center">
                                        <button class="btn btn-sm btn-outline-primary check_in" type="button" data-id="<?php echo $row['id'] ?>">Book</button>
                                    </td>
                                </tr>
                            <?php endwhile; ?>
                            </tbody>
...
<script>
    ...
    $('.check_in').click(function(){
        uni_modal("Book","manage_check_in.php?rid="+$(this).attr("data-id"))
    })
